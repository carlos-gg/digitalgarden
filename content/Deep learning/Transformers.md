...
- [Transformador generativo preentrenado - Wikipedia, la enciclopedia libre](https://es.wikipedia.org/wiki/Transformador_generativo_preentrenado)
...
- [Transformer Neural Network Definition | DeepAI](https://deepai.org/machine-learning-glossary-and-terms/transformer-neural-network)
- [Arquitectura de transformadores en pocas palabras - FourWeekMBA](https://fourweekmba.com/es/arquitectura-del-transformador/)
